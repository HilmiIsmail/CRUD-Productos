<x-app-layout>
    <x-principal>
        {{-- mostraremos los productos disponibles en un grid --}}
        <div class="p-2 border-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 ">
            @foreach ($productos as $item)
                <article @class([
                    ...
                    <div class="w-full h-full flex flex-col justify-around items-center p-2 bg-opacity-50">
                        ...
                        <div class="italic bg-white p-1 rounded">
                            {{ $item->user->email }}
                        </div>
